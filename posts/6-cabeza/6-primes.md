---
title: Cabeza Board Game Engine
tags: posts
description: |
  Cabeza
layout: post.njk
permalink: /posts/cabeza/
...
Except for the _cabeza_, the pieces consist of integer-sided rectangular prisms which are always aligned to the board grid (called block pieces).
